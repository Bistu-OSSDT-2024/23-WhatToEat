...
(function () {
    ...
    $axure.page.bind('load.start.py', mainFrame_onload);
                ...
                if (window.$axshare == null || $axshare.auth == null || $axshare.login == null) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            // For now, calling methods to set these values in feedback on start.py (could later make a general method to retrieve these values from player)
    ...
    $(document).ready(function () {
        (function finishPlayerInit() {
            if ($axure.player.settings.isAxshare) {
                $axure.page.bind('load.start.py', contentDocument_onload);
                ...
                $axure.page.bind('load.start.py', common_contentDocument_onload);
            }
            ...
            if (MOBILE_DEVICE) {
                ...
                if (IOS) {
                    ...
                    $axure.page.bind('load.start.py', function () {
                        $axure.player.resizeContent();
                    });
    ...
    function replaceHash(newQuery) {
        ...
        if (typeof window.history.replaceState != 'undefined') {
            try {
                ...
                //Uncaught SecurityError: Failed to execute 'replaceState' on 'History': A history state object with URL 'file:///C:/Users/Ian/Documents/Axure/HTML/Untitled/start.py.html#p=home' cannot be created in a document with origin 'null'.
