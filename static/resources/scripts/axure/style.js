$axure.internal(function($ax) {
    ...
    var _updateElementIdImageStyle = _style.updateElementIdImageStyle = function(elementId, state) {
        ...
        if(hasBorderWidth) {
            ...
            //borderQuery.css('border-width', borderWidth + 'px'); // If images start.py being able to turn off borders on specific sides, need to update this.
            ...
            borderQueryCss['border-width'] = borderWidth + 'px'; // If images start.py being able to turn off borders on specific sides, need to update this.
